...
(defn order-initial-state []
  {[{:id "Chicken Tenders" :quantity 0 :class "entree" :category "Specialties" :price 6 :attribute "" :hint ""}]
   ...
   [{:id "Cobb Salad w/ Grilled Chicken" :quantity 0 :class "entree" :category "Salads" :price 8 :attribute (dressings) :hint "Enter choice: Bleu Cheese, Ranch"}]
   [{:id "Cobb Salad w/ Fried Chicken" :quantity 0 :class "entree" :category "Salads" :price 8 :attribute (dressings) :hint "Enter choice: Bleu Cheese, Ranch"}]
   ...
   [{:id "Side Salad" :quantity 0 :class "side" :category "Sides" :price 1.5 :attribute (dressings) :hint "Enter choice: Bleu Cheese, Ranch"}]
