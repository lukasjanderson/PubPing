...
(defn order-initial-state []
  {[{:id "Chicken Tenders" :quantity 0 :class "entree" :category "Specialties" :price 6 :attribute "" :hint ""}]
   ...
   [{:id "Cobb Salad" :quantity 0 :class "entree" :category "Salads" :price 6 :attribute (dressings) :hint "Enter choice: Blue cheese, ranch"}]
   [{:id "Cobb Salad w/ Tofu" :quantity 0 :class "entree" :category "Salads" :price 8 :attribute (dressings) :hint "Enter choice: Blue cheese, ranch"}]
   [{:id "Cobb Salad w/ Grilled Chicken" :quantity 0 :class "entree" :category "Salads" :price 8 :attribute (dressings) :hint "Enter choice: Blue cheese, ranch"}]
   [{:id "Cobb Salad w/ Fried Chicken" :quantity 0 :class "entree" :category "Salads" :price 8 :attribute (dressings) :hint "Enter choice: Blue cheese, ranch"}]
   [{:id "Pub Burger" :quantity 0 :class "entree" :category "Burgers" :price 6 :attribute (cheeses) :hint "Enter choice: American, Swiss, Cheddar, Provolone"}]
   [{:id "Pub Burger w/ Bacon" :quantity 0 :class "entree" :category "Burgers" :price 7 :attribute (cheeses) :hint "Enter choice: American, Swiss, Cheddar, Provolone"}]
   ...
   [{:id "Milkshake" :quantity 0 :class "side" :category "Desserts" :price 4 :attribute (flavors) :hint "Enter choice: Chocolate, Strawberry, Vanilla, Special"}]
   ...
   [{:id "Side Salad" :quantity 0 :class "side" :category "Sides" :price 1.5 :attribute (dressings) :hint "Enter choice: Blue cheese, ranch"}]
